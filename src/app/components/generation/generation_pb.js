...
goog.exportSymbol('proto.gooseai.ArtifactTypeFilter', null, global);
...
goog.exportSymbol('proto.gooseai.ContentCredentialsParameters', null, global);
goog.exportSymbol('proto.gooseai.ContentCredentialsParameters.ModelMetadata', null, global);
goog.exportSymbol('proto.gooseai.ContentCredentialsParameters.ParametersCase', null, global);
 ...
 * @constructor
 */
proto.gooseai.ContentCredentialsParameters = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.gooseai.ContentCredentialsParameters.oneofGroups_);
};
goog.inherits(proto.gooseai.ContentCredentialsParameters, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.ContentCredentialsParameters.displayName = 'proto.gooseai.ContentCredentialsParameters';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.gooseai.ArtifactTypeFilter = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.gooseai.ArtifactTypeFilter.repeatedFields_, null);
};
goog.inherits(proto.gooseai.ArtifactTypeFilter, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.ArtifactTypeFilter.displayName = 'proto.gooseai.ArtifactTypeFilter';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.gooseai.ContentCredentialsParameters.oneofGroups_ = [[1]];
...
/**
 * @return {proto.gooseai.ContentCredentialsParameters.ParametersCase}
 */
proto.gooseai.ContentCredentialsParameters.prototype.getParametersCase = function() {
  return /** @type {proto.gooseai.ContentCredentialsParameters.ParametersCase} */(jspb.Message.computeOneofCase(this, proto.gooseai.ContentCredentialsParameters.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.gooseai.ContentCredentialsParameters.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.ContentCredentialsParameters.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.ContentCredentialsParameters} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.ContentCredentialsParameters.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.ContentCredentialsParameters}
 */
proto.gooseai.ContentCredentialsParameters.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.ContentCredentialsParameters;
  return proto.gooseai.ContentCredentialsParameters.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.ContentCredentialsParameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.ContentCredentialsParameters}
 */
proto.gooseai.ContentCredentialsParameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.gooseai.ContentCredentialsParameters.ModelMetadata} */ (reader.readEnum());
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.ContentCredentialsParameters.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.ContentCredentialsParameters.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.ContentCredentialsParameters} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.ContentCredentialsParameters.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = /** @type {!proto.gooseai.ContentCredentialsParameters.ModelMetadata} */ (jspb.Message.getField(message, 1));
  if (f != null) {
    writer.writeEnum(
      1,
      f
 ...
 * @enum {number}
 */
proto.gooseai.ContentCredentialsParameters.ModelMetadata = {
 ...
 * @return {!proto.gooseai.ContentCredentialsParameters.ModelMetadata}
 */
proto.gooseai.ContentCredentialsParameters.prototype.getModelMetadata = function() {
  return /** @type {!proto.gooseai.ContentCredentialsParameters.ModelMetadata} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.gooseai.ContentCredentialsParameters.ModelMetadata} value
 * @return {!proto.gooseai.ContentCredentialsParameters} returns this
 */
proto.gooseai.ContentCredentialsParameters.prototype.setModelMetadata = function(value) {
  return jspb.Message.setOneofField(this, 1, proto.gooseai.ContentCredentialsParameters.oneofGroups_[0], value);
};
 ...
 * @return {!proto.gooseai.ContentCredentialsParameters} returns this
 */
proto.gooseai.ContentCredentialsParameters.prototype.clearModelMetadata = function() {
  return jspb.Message.setOneofField(this, 1, proto.gooseai.ContentCredentialsParameters.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.gooseai.ContentCredentialsParameters.prototype.hasModelMetadata = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.gooseai.ImageParameters.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    contentCredentialsParameters: (f = msg.getContentCredentialsParameters()) && proto.gooseai.ContentCredentialsParameters.toObject(includeInstance, f)
  };
...
proto.gooseai.ImageParameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 13:
      ...
      break;
    case 14:
      var value = new proto.gooseai.ContentCredentialsParameters;
      reader.readMessage(value,proto.gooseai.ContentCredentialsParameters.deserializeBinaryFromReader);
      msg.setContentCredentialsParameters(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.gooseai.ImageParameters.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getContentCredentialsParameters();
  if (f != null) {
    writer.writeMessage(
      14,
      f,
      proto.gooseai.ContentCredentialsParameters.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional ContentCredentialsParameters content_credentials_parameters = 14;
 * @return {?proto.gooseai.ContentCredentialsParameters}
 */
proto.gooseai.ImageParameters.prototype.getContentCredentialsParameters = function() {
  return /** @type{?proto.gooseai.ContentCredentialsParameters} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.ContentCredentialsParameters, 14));
};


/**
 * @param {?proto.gooseai.ContentCredentialsParameters|undefined} value
 * @return {!proto.gooseai.ImageParameters} returns this
*/
proto.gooseai.ImageParameters.prototype.setContentCredentialsParameters = function(value) {
 ...
 * @return {!proto.gooseai.ImageParameters} returns this
 */
proto.gooseai.ImageParameters.prototype.clearContentCredentialsParameters = function() {
  return this.setContentCredentialsParameters(undefined);
};
 ...
 * @return {boolean}
 */
proto.gooseai.ImageParameters.prototype.hasContentCredentialsParameters = function() {
  return jspb.Message.getField(this, 14) != null;
};
...
proto.gooseai.OnStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    artifactType: (f = msg.getArtifactType()) && proto.gooseai.ArtifactTypeFilter.toObject(includeInstance, f)
  };
...
proto.gooseai.OnStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.gooseai.ArtifactTypeFilter;
      reader.readMessage(value,proto.gooseai.ArtifactTypeFilter.deserializeBinaryFromReader);
...
proto.gooseai.OnStatus.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.gooseai.ArtifactTypeFilter.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.gooseai.ArtifactTypeFilter}
 */
proto.gooseai.OnStatus.prototype.getArtifactType = function() {
  return /** @type{?proto.gooseai.ArtifactTypeFilter} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.ArtifactTypeFilter, 4));
};


/**
 * @param {?proto.gooseai.ArtifactTypeFilter|undefined} value
 * @return {!proto.gooseai.OnStatus} returns this
*/
proto.gooseai.OnStatus.prototype.setArtifactType = function(value) {
  return jspb.Message.setWrapperField(this, 4, value);
};
 ...
 * @return {!proto.gooseai.OnStatus} returns this
 */
proto.gooseai.OnStatus.prototype.clearArtifactType = function() {
 ...
 * @return {boolean}
 */
proto.gooseai.OnStatus.prototype.hasArtifactType = function() {
  return jspb.Message.getField(this, 4) != null;
};
 ...
 * @const
 */
proto.gooseai.ArtifactTypeFilter.repeatedFields_ = [1,2];
 ...
 * @return {!Object}
 */
proto.gooseai.ArtifactTypeFilter.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.ArtifactTypeFilter.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.ArtifactTypeFilter} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.ArtifactTypeFilter.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.gooseai.ArtifactTypeFilter}
 */
proto.gooseai.ArtifactTypeFilter.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.ArtifactTypeFilter;
  return proto.gooseai.ArtifactTypeFilter.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.ArtifactTypeFilter} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.ArtifactTypeFilter}
 */
proto.gooseai.ArtifactTypeFilter.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var values = /** @type {!Array<!proto.gooseai.ArtifactType>} */ (reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]);
      for (var i = 0; i < values.length; i++) {
        msg.addInclude(values[i]);
      }
      break;
    case 2:
      var values = /** @type {!Array<!proto.gooseai.ArtifactType>} */ (reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]);
      for (var i = 0; i < values.length; i++) {
        msg.addExclude(values[i]);
      }
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.ArtifactTypeFilter.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.ArtifactTypeFilter.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.ArtifactTypeFilter} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.ArtifactTypeFilter.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<!proto.gooseai.ArtifactType>}
 */
proto.gooseai.ArtifactTypeFilter.prototype.getIncludeList = function() {
  return /** @type {!Array<!proto.gooseai.ArtifactType>} */ (jspb.Message.getRepeatedField(this, 1));
};


/**
 * @param {!Array<!proto.gooseai.ArtifactType>} value
 * @return {!proto.gooseai.ArtifactTypeFilter} returns this
 */
proto.gooseai.ArtifactTypeFilter.prototype.setIncludeList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.gooseai.ArtifactTypeFilter} returns this
 */
proto.gooseai.ArtifactTypeFilter.prototype.addInclude = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.gooseai.ArtifactTypeFilter} returns this
 */
proto.gooseai.ArtifactTypeFilter.prototype.clearIncludeList = function() {
 ...
 * @return {!Array<!proto.gooseai.ArtifactType>}
 */
proto.gooseai.ArtifactTypeFilter.prototype.getExcludeList = function() {
  return /** @type {!Array<!proto.gooseai.ArtifactType>} */ (jspb.Message.getRepeatedField(this, 2));
};
 ...
 * @return {!proto.gooseai.ArtifactTypeFilter} returns this
 */
proto.gooseai.ArtifactTypeFilter.prototype.setExcludeList = function(value) {
  return jspb.Message.setField(this, 2, value || []);
};
 ...
 * @return {!proto.gooseai.ArtifactTypeFilter} returns this
 */
proto.gooseai.ArtifactTypeFilter.prototype.addExclude = function(value, opt_index) {
 ...
 * @return {!proto.gooseai.ArtifactTypeFilter} returns this
 */
proto.gooseai.ArtifactTypeFilter.prototype.clearExcludeList = function() {
